...
| ID | Memo | Severity | Title | Status | Rationale / PR |
|---|---|---|---|---|---|
| DA-2 | [06-DA](./06-DA-docs-review.md#f-2) | NOTE→CHALLENGE | Normalize D-NNN anchors to full slug across blueprint set | open | |
| DA-3 | [06-DA](./06-DA-docs-review.md#f-3) | NOTE | Verify F-CON-001 fix landed (10-Epic → 11-Epic in repo CLAUDE.md) | open | |
| DA-4 | [06-DA](./06-DA-docs-review.md#f-4) | CHALLENGE | Add `000-docs/000-INDEX.md` flat index per F-CON-004 | open | |
| DA-5 | [06-DA](./06-DA-docs-review.md#f-5) | CHALLENGE | Add explicit `CONTRIBUTING.md` required-sections list to ROADMAP § E1 | open | |
| DA-6 | [06-DA](./06-DA-docs-review.md#f-6) | CHALLENGE | Renumber `audits/README.md` to 03-AR..13-FC | open | |
| CC-1 | [12-CC](./12-CC-consistency-review.md#f-1) | PASS-followup | Verify F-CON-002 + F-CON-003 fixes merged | open | |
| CC-3 | [12-CC](./12-CC-consistency-review.md#f-3) | CHALLENGE | Verify F-CON-001 fix merged (cross-references DA-3) | open | |
| CC-4 | [12-CC](./12-CC-consistency-review.md#f-4) | CHALLENGE | D-021 sandbox-terminology normalization pass | open | |
| CC-7 | [12-CC](./12-CC-consistency-review.md#f-7) | CHALLENGE | Renumber `audits/README.md` (cross-references DA-6) | open | |
